...
**Status:** Approved 2026-07-07. Branch `feat/theming-engine` (stacked on `feat/custom-start-stop-sounds`).
...
interface ThemeDef { id: string; label: string; appearance: Appearance; }
...
:root[data-theme="tokyo-night"] {
  color-scheme: dark;
  --color-text: #c0caf5; --color-background: #1a1b26;
  --color-mid-gray: #565f89; --color-logo-primary: #7aa2f7;
  --color-background-ui: #7aa2f7; --color-logo-stroke: #bb9af7;
  --color-text-stroke: #1a1b26; --color-log-surface: #16161e;
}
```
